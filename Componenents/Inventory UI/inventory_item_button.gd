...
func _ready() -> void:
	...
	style_box_flat_with_things_on_th_outside.border_width_left = 2 
	style_box_flat_with_things_on_th_outside.border_width_right = 2 
	style_box_flat_with_things_on_th_outside.set_corner_radius_all(3)
